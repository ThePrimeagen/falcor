...
// Observer interface
//------------------------
GetSourceRequest.prototype.onNext = function(data) {
    this._jsonGraphData = data;
};
GetSourceRequest.prototype.onError = function(err) {
    this.complete(err, this._jsonGraphData);
};
GetSourceRequest.prototype.onCompleted = function() {
    this.complete(null, this._jsonGraphData);
};
