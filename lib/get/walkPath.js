...
module.exports = function walkPath(model, root, curr, path, depth, seed,
    ...
    do {
        ...
        hasValue = walkPath(model, root, next, path, nextDepth, seed, outerResults,
                requestedPath, nextOptimizedPath, nextOptimizedLength,
                isJSONG, fromReference) || hasValue;
    ...
    // TODO: Unroll output build if hasValue is false and parent is true.
